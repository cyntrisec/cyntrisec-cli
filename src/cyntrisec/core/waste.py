...
class UnusedCapability:
    ...
    service: str
    service_name: str
    days_unused: Optional[int] = None  # None means never used
...
class WasteAnalyzer:
        ...
        for svc in usage.services:
            ...
            if is_unused:
                ...
                if days_unused is None:
                    ...
                    recommendation = f"Remove {svc.service_name} access - unused for {days_unused} days"
                
                role_waste.unused_capabilities.append(UnusedCapability(
                    role_arn=usage.role_arn,
                    role_name=usage.role_name,
                    service=namespace,
    ...
    def analyze_from_assets(
        self,
        assets: List[Asset],
        usage_reports: Optional[List[any]] = None,
    ) -> WasteReport:
        """
